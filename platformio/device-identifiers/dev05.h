...
static const u4_t DEVADDR = 0x12340205;

// NWKSKEY: network specific session key
static const u1_t NWKSKEY[16] PROGMEM = { 0x5E, 0x45, 0x2D, 0xBC, 0x23, 0xA5, 0x40, 0x6C, 0xE1, 0x23, 0x68, 0xEF, 0x78, 0xAE, 0x16, 0x55 };

// APPSKEY: Application specific session key
static const u1_t APPSKEY[16] PROGMEM = { 0x5E, 0x45, 0x2D, 0xBC, 0x23, 0xA5, 0x40, 0x6C, 0xE1, 0x23, 0x68, 0xEF, 0x78, 0xAE, 0x16, 0x55 };
x16, 0x55 };
